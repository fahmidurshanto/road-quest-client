      ...
      <div className="max-w-md w-full bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden transition-all duration-500 hover:shadow-3xl">
        <div className="p-8 text-center">
          ...
          <div className="mt-8 flex justify-center gap-4 animate__animated animate__fadeInUp animate__delay-3s">
            ...
            <button 
              onClick={() => navigate(-1)} // Added click handler
              className="cursor-pointer flex items-center gap-2 px-6 py-3 border border-indigo-600 text-indigo-600 rounded-xl hover:bg-indigo-50 transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg"
            >
              <FaArrowLeft />
              Go Back
            </button>
